# -*- coding: utf-8 -*-
"""
Created on Thu Sep 28 19:19:18 2017

@author: Jyler
"""
#### 6 layer (4 hidden layers) neural net. Made when learning how to use TensorFlow.
#### Does not implement regularization. I wanted to compare how it performed on MNIST 
#### with regularization, and w/o.
...
t0 = time.time()
file_location = "C:/Users/Jyler/Documents/DataSci_ML"
testfile = file_location + "/test.csv"
trainfile = file_location + "/train.csv"
testfile2 = file_location + "/test.csv"

df_init = pd.read_csv(trainfile)
df_test_init = pd.read_csv(testfile2)
...
#test_label_dataset = df_test_init['label'].values
...
#test_labels = reformat(test_label_dataset);

## Function to write the predictions for the test data to a file.csv
## Kaggle likes .csv files.
